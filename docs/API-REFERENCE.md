	...
	"data": [
		{
			...
			"risk_score_breakdown": {
				...
				"components": {
					...
					"validationFrequency": { "score": 100, "weight": 0.1, "contribution": 10, "reason": "3 validations in 1h" },
...
```typescript
const ALLOWED_ORIGINS = ['https://form.erfi.dev', 'https://erfi.dev', 'https://erfianugrah.com'];
