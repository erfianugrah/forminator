...
export interface BlockedValidation {
	...
	challenge_ts: string;
	ja4: string | null;
	detection_type: 'token_replay' | 'ephemeral_id_fraud' | 'ja4_session_hopping' | 'ip_diversity' | 'validation_frequency' | 'turnstile_failed' | 'duplicate_email' | 'email_fraud' | 'other' | null;
}
