...
export function CountrySelect({ value, onChange, disabled }: CountrySelectProps) {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="text-xl leading-none" style={{ fontFamily: '"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"' }}>{selectedCountry.emoji}</span>
          ...
          <div className="max-h-[300px] overflow-y-auto p-1">
            {filteredCountries.length === 0 ? (
              ...
              filteredCountries.map((country) => (
                ...
                >
                  <span className="text-xl" style={{ fontFamily: '"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"' }}>{country.emoji}</span>
