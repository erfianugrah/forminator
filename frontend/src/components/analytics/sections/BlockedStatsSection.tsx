								...
								>
									<div className="flex-1 space-y-2">
										<div className="flex items-center justify-between">
											<p className="font-semibold text-sm">{reason.block_reason}</p>
											<span className={`px-2 py-1 rounded-full text-xs font-medium ${getFrequencyColor(reason.count)}`}>
												{reason.count} blocked
											</span>
										</div>
										<div className="grid grid-cols-3 gap-4 text-xs">
											<div>
												<span className="text-muted-foreground">Unique Ephemeral IDs:</span>
